...
export const createUserSchema = z.object({
  ...
  role: z.enum(['master', 'admin', 'cliente', 'operador'], { message: "El rol debe ser 'master', 'admin', 'cliente' o 'operador'." }).default('cliente').optional(),
...
export const updateUserSchema = z.object({
  ...
  role: z.enum(['master', 'admin', 'cliente', 'operador'], { message: "El rol debe ser 'master', 'admin', 'cliente' o 'operador'." }).optional(),
