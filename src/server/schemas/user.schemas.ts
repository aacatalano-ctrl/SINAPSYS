...
export const createUserSchema = z.object({
  ...
  role: z
    .enum(['master', 'admin', 'cliente', 'operador'], {
      message: "El rol debe ser 'master', 'admin', 'cliente' o 'operador'.",
    })
    .default('cliente')
    .optional(),
  status: z
    .enum(['active', 'blocked'], { message: "El estado debe ser 'active' o 'blocked'." })
    .default('active')
    .optional(),
});
